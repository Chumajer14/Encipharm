...
Estado: cerrado para Development e incorporado al cierre MVP web.  
...
- E2E completo queda reemplazado para este cierre por smoke test operativo y pruebas backend/frontend disponibles.
- Migracion historica no forma parte del cierre MVP web.
- Los listados actuales usan lectura completa de colecciones y filtros en memoria; es aceptable para el volumen del MVP web cerrado.
